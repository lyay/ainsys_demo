...
Функция ОтправитьЗапрос(Сессия, ПодготовленныйЗапрос, Настройки)
	...
	ПодготовленныйОтвет.Вставить("Ответ", Ответ); // lyay 20211216
...
Функция РаспаковатьОтвет(Ответ) Экспорт
...
//
Процедура Приостановить(ДлительностьОстановкиВСекундах) Экспорт
